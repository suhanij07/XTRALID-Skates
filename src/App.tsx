...
function App() {
  ...
  return <main className="min-h-screen overflow-hidden bg-black text-white">
    ...
    <section ref={scrubSection} className="relative h-screen min-h-[620px] overflow-hidden bg-black">
      ...
      <motion.div initial={{opacity:0,y:16}} animate={{opacity:1,y:0}} transition={{duration:.7}} className="absolute left-4 top-4 z-10 sm:left-8 sm:top-7">
        <div className="text-[clamp(3.4rem,9vw,8rem)] font-medium leading-[.72] tracking-[-.075em]">XTRALID<span className="align-top text-[.14em] tracking-normal">®</span></div>
      </motion.div>
